  ...
  log(level, msg, ...splat) { // eslint-disable-line max-params
    ...
    if (arguments.length === 1) {
      ...
      if (typeof level.meta === 'object' && level.meta !== null) {
        level.message2 = (level.meta.message) ? level.meta.message : '';
        delete level.meta.message;
        level.message3 = (Object.keys(level.meta).length > 0) ? JSON.stringify(level.meta) : '';
      } else if (typeof level.meta === 'string') {
        level.message2 = level.meta;
        level.message3 = '';
      } else {
        level.message2 = '';
        level.message3 = '';
    ...
    if (typeof meta === 'object' && meta !== null) {
      let msg2 = (meta.message) ? meta.message : '';
      delete meta.message;
      this.write(Object.assign({}, meta, {
        ...
        message: msg,
        message2: msg2,
        message3: JSON.stringify(meta)
      }));
    } else {
      let msg2 = (typeof meta === 'string') ? meta : '';
